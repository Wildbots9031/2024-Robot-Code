...
public class IntakeWheelsOffWithButton extends Command {
  /** Creates a new IntakeWheelsOffWithButton. */

  private final intakeWheels m_intakeWheels;

  public IntakeWheelsOffWithButton(intakeWheels intake_wheels) {
