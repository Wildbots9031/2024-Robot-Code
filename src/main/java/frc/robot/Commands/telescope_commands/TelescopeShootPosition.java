...
public class TelescopeShootPosition extends Command {
  /** Creates a new TelescopeShootPosition. */
  private final telescope m_telescope;

  public TelescopeShootPosition(telescope m_telescope) {
  ...
  public void initialize() {
    m_telescope.telescope_shoot_postion();
  }
