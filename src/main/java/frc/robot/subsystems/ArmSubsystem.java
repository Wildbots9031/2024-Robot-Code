...
public class ArmSubsystem extends SubsystemBase {
  ...
  private CANSparkMax m_armRotationMotor;
    ...
    {
        m_PIDTelescope.setReference(position, ControlType.kPosition);
    }

    public double getTelescopePosition()
    {
       return m_armTelescopingMotor.getEncoder().getPosition();
    }

    public void setRotationPosition(double position)
    {
        m_PIDArmRotation.setReference(position, ControlType.kPosition);
    }

    public double getArmRotationPosition()
    {
        return m_armRotationMotor.getEncoder().getPosition();
    }
    ...
    public void setIntakePickUpWheelsSpeed(double speed)
    {
        m_PIDIntakePickUpWheels.setReference(speed, ControlType.kVelocity);
    }

    public double getIntakePickUpWheelsSpeed()
    {
        return m_intakePickUpWheels.getEncoder().getVelocity();
    }

    public void setShooter(double speed)
    {
        m_PIDLeftShooter.setReference(speed, ControlType.kVelocity);
        m_PIDRightShooter.setReference(speed, ControlType.kVelocity);
    }
